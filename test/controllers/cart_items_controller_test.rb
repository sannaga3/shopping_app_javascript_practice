...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { cart_id: @cart_item.cart_id, quantitiy: @cart_item.quantitiy } }
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { cart_id: @cart_item.cart_id, quantitiy: @cart_item.quantitiy } }
